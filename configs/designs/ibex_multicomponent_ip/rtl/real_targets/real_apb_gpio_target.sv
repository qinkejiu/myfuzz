module real_apb_gpio_target (
    ...
    apb4_mmio_bridge #(.ADDRESS_WIDTH(32), .DATA_WIDTH(32)) u_bridge (
    ...
    apb4_mmio_target #(.ADDRESS_WIDTH(32), .DATA_WIDTH(32)) u_target (
    ...
    ibex_mcip_gpio u_gpio (
        ...
        .addr_i(mmio_addr), .wdata_i(mmio_wdata), .pins_i(16'h0000), .rdata_o(mmio_rdata),
        .irq_o(), .state_o()
    );
endmodule
