    ...
    return [
        {
            ...
            "capabilities": {"partial_write": True, "read": True, "write": True, "max_wait_cycles": 16, "data_width": 32},
            "evidence": {
        ...
        },
        {
            ...
            "capabilities": {"partial_write": False, "read": True, "write": False, "max_wait_cycles": 2, "data_width": 32},
            "evidence": {
        ...
        "routes": [
            {
                ...
                "parameters": {"ADDR_WIDTH": 32, "READ_ONLY": 1},
