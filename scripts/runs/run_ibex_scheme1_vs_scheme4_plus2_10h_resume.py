#!/usr/bin/env python3
"""Run Ibex scheme1 vs long-run scheme4_plus2 for a resumable 10h comparison."""
...
SCHEMES = [
    ...
    },
    {
        "scheme": "scheme4p2",
        "label": "scheme4_plus2",
        "config": "configs/designs/ibex_lightweight_plus2/config.json",
        "reuse_out_dir": "runs/designs/ibex_lightweight_plus2",
        "description": (
            "Top-level ibex_core scheme4_plus2 with stable short programs, a small RF model, "
            "correlated data memory, variable bus latency, and low-frequency trap/debug/error exploration."
        ),
    },
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--label", default="ibex_scheme1_vs_scheme4_plus2_resume")
...
def main() -> int:
    ...
    manifest.update({
        ...
        "coverage_metric": (
            "Cumulative union coverage over actual __vi_coverage bit indices common to all configured schemes. "
            f"Ibex run excludes {args.exclude_top_bits} top MSB bits by default."
        ),
